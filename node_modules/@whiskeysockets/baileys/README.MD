# <div align='center'>MaulEnv - A WebSockets library for interacting with WhatsApp Web</div>

<div align="center">


**MaulEnv** is a fast, stable, and modern interactive-feature-focused WhatsApp Web API library built on WebSocket.
...
```
npm install github:MaulEnv
```

Then import your code using:

```js
import makeWASocket from 'MaulEnv'
```
...
```js
import makeWASocket, { useMultiFileAuthState } from 'MaulEnv'
...
```js
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from 'MaulEnv'
...
import { makeInMemoryStore, getAggregateVotesInPollMessage } from 'MaulEnv'
...
```js
import { jidNormalizedUser, getAggregateResponsesInEventMessage } from 'MaulEnv'
...
```js
import makeWASocket, { makeInMemoryStore } from 'MaulEnv'
                ...
                payment_settings: [
                    {
                        ...
                        pix_static_code: {
                            merchant_name: 'MaulEnv',
                            key: 'example@MaulEnv.com',
...
Rich Message adalah fitur UI premium pada MaulEnv yang mendukung markdown, code block, table, images, video, product card, social post, reels, sources, suggestions, dan tip dalam satu pesan.
...
await conn.sendMessage(
    id,
    {
        album: [{
        	image: {
        		url: 'https://example.com/MaulEnv.jpg'
        	},
        	caption: 'Hay'
        }, {
        	image: Buffer,
        	...
        	video: {
        		url: 'https://example.com/MaulEnv.mp4'
        	},
        	caption: 'Hay'
        }, {
        	video: Buffer,
...
import { downloadMediaMessage, getContentType } from 'MaulEnv'
